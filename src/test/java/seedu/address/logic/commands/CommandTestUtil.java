...
import static seedu.address.logic.parser.CliSyntax.PREFIX_POLICYLIST;
...
public class CommandTestUtil {
    ...
    public static final String VALID_POLICYNAME_AMY = "Health";
    public static final String VALID_POLICYNAME_BOB = "Personal Accident";
    public static final String VALID_DATE_AMY = "01/02/2023";
    public static final String VALID_DATE_BOB = "02/03/2023";
    public static final String VALID_PREMIUM_AMY = "156.70";
    public static final String VALID_PREMIUM_BOB = "80.5";
    public static final String VALID_FREQUENCY_AMY = "quarterly";
    ...
    public static final String POLICYNAME_DESC_AMY = " " + PREFIX_POLICYLIST + VALID_POLICYNAME_AMY;
    public static final String POLICYNAME_DESC_BOB = " " + PREFIX_POLICYLIST + VALID_POLICYNAME_BOB;
