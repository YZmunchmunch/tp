...
public class EditCommand extends Command {
    ...
    private static Client createEditedClient(Client clientToEdit, EditClientDescriptor editClientDescriptor) {
        ...
        PolicyList updatedPolicyList = editClientDescriptor.getPolicyList().orElse(clientToEdit.getPolicyList());
        Set<Tag> updatedTags = editClientDescriptor.getTags().orElse(clientToEdit.getTags());

        return new Client(updatedName, updatedPhone, updatedEmail, updatedAddress, updatedPolicyList, updatedTags);
    }
    ...
    public static class EditClientDescriptor {
        ...
        public boolean isAnyFieldEdited() {
            return CollectionUtil.isAnyNonNull(name, phone, email, address, policies, tags);
        }
        ...
        public Optional<PolicyList> getPolicyList() {
        ...
        public boolean equals(Object other) {
            ...
            return getName().equals(e.getName())
                    ...
                    && getPolicyList().equals(e.getPolicyList())
